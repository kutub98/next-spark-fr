...
// // ✅ Helper function to export leaderboard as CSV
...
//   // ✅ Fetch quizzes and participations
//   useEffect(() => {
...
//   console.log(certificate, "certificate state in leaderboard");
//   console.log(leaderboard, "leaderboard data");

//   return (
//     <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-3 p-0 sm:px-4">
...
//                             const certQuizId =
//                               cert.participation?.quiz?._id?.toString();
//                             const certUserId =
//                               cert.participation?.user?._id?.toString();

//                             const entryId = entry?._id?.toString();
//                             const entryQuizId = entry?.quiz?._id?.toString();
//                             const entryUserId = entry?.user?._id?.toString();

//                             return (
//                               certParticipationId === entryId ||
//                               (certQuizId === entryQuizId &&
//                                 certUserId === entryUserId)
//                             );
//                           })
//                         : null;
...
//                                   onClick={() => {
//                                     const link = document.createElement("a");
//                                     link.href = matchedCert.imageUrl;
//                                     link.download = `${
//                                       entry.user?.fullNameEnglish ||
//                                       "certificate"
//                                     }-certificate.png`;
...
//             if (!open) fetchCertificate(); // ✅ Refresh certificate list when modal closes
//           }}
